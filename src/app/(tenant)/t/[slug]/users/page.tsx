    ...
    return (
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-3 text-[var(--color-ink-muted)]">
          ...
          tenant_admin o al superusuario que te invite.
        </p>
    ...
    <div className="mx-auto flex max-w-5xl flex-col gap-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-[var(--color-ink-muted)]">
            Sesión: {ctx.email}
            {membership ? ` · rol ${membership.role}` : " · platform_superuser"}
      ...
      {canInvite ? <InviteMemberForm slug={slug} /> : (
        <p className="rounded-[var(--radius-lg)] border border-[var(--color-warning)]/30 bg-[var(--color-warning-soft)] px-4 py-3 text-sm text-[var(--color-warning)]">
          Tu rol no puede invitar usuarios (hace falta tenant_admin o
          superusuario).
        </p>
      )}
